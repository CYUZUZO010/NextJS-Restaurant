      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="border-stone-300 focus-visible:ring-amber-400 focus-visible:border-amber-400"
                      />
                    </div>
                    <div className="space-y-2">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600">KK-523 Culinary Street</p>
          ...
          <Card className="mt-8 bg-white/90 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <CardContent>
              <div className="aspect-video rounded-lg overflow-hidden border border-stone-200">
                <iframe
                  title="Bella Vista Restaurant Map - Kigali"
