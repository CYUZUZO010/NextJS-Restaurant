  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-neutral-100 to-amber-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md mb-4 text-center">
        ...
        <p className="animate-slide-up mt-1 text-stone-700 font-medium" style={{ animationDelay: "120ms" }}>Sign up to continue</p>
      </div>
        ...
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} required className="border-stone-300 focus-visible:ring-amber-400 focus-visible:border-amber-400" />
            </div>
            <div className="space-y-2">
          ...
          <p className="text-sm text-stone-600 mt-4">
            Already have an account? <Link className="text-amber-700 hover:text-amber-800 underline underline-offset-4" href="/auth/signin">Sign in</Link>
          </p>
        </CardContent>
      </Card>
    </div>
